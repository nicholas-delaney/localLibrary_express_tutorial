...
exports.author_update_post =  [
    ...
    (req, res, next) => {
        ...
        // creat new author object with new data
        var author = new Author(
            {
                first_name: req.body.first_name,
        ...
        if (!errors.isEmpty()) {
            // There are errors, render form again with new data and list of errors
            ...
            Author.findByIdAndUpdate(req.params.id, author, {}, function(err, result) {
                if (err) { return nexst(err); }
                // success - redirect to new author's details
